...
const TikTokIcon: React.FC<TikTokIconProps> = ({ className }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
    <path d="M19.589 6.686a4.793 4.793 0 01-3.77-4.245V2h-3.445v13.672a2.896 2.896 0 01-5.201 1.743l-.002-.001a2.895 2.895 0 113.183-4.51v-3.5a6.329 6.329 0 00-1.183-.11 6.396 6.396 0 106.396 6.396V8.373a8.217 8.217 0 004.334 1.231v-3.445a4.792 4.792 0 01-.312-.473z"/>
  </svg>
);
